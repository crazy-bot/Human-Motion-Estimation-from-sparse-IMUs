...
class TrainingEngine:
    def __init__(self):
        self.datapath = '/data/Guha/GR/Dataset/DIP_IMU2/'
        self.modelPath = '/data/Guha/GR/model/dip_calib/'
    ...
    def train(self,n_epochs):
        ...
        self.dataset = IMUDataset(self.datapath, ['train'])
        min_valid_loss = 0.0
        for epoch in range(0, n_epochs):
            train_loss = []
            start_time = time()
            self.dataset.loadfiles(self.datapath,['train'])
            ####################### training #######################
            ...
            valid_loss = []
            self.model.eval()
            self.dataset.loadfiles(self.datapath, ['validation'])
